...
The harness orchestrator should be proactive, not passive. At each major boundary, choose core council experts and domain specialists from `harness-experts.v4` to improve evidence, risk control, or strategy quality.
